...
class DAO {
	...
	private $LISTAAUTA = "SELECT *FROM auto";
	private $INSERTAUTO = "INSERT INTO auto(marka, cena) VALUES (?, ?)";
	...
	public function insertAuto($marka,$cena){
	...
	public function svi(){
		$statement = $this->db->prepare($this->LISTAAUTA);
