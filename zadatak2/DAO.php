...
class DAO {
	...
	private $GETKLIJENTBYUSER = "SELECT *FROM klijent WHERE user = ?";
	...
	public function getKlijent($user){

		$statement = $this->db->prepare($this->GETKLIJENTBYUSER);
	...
	public function getKlijentByUser($user){
